...
export default function Header() {
    ...
    const HeaderLetter = ({text, className}) => (
        <h1 className={`font-Londrina text-6xl sm:text-8xl  ${className}`}>{text}</h1>
    );
    ...
    return (
        ...
        <HeaderLetter className="animate-fade-in-down-3 md:mt-10 text-indigo-400" text={`P`}/> 
        ...
        <HeaderLetter className="animate-fade-in-down-3 md:mt-10 text-red-600" text={`r`}/> 
            ...
            <div className="flex w-screen justify-center">
        <HeaderLetter className="animate-fade-in-down-1 md:mt-20 text-indigo-400"text={`A`}/> 
        ...
        <HeaderLetter className="animate-fade-in-down-2 md:mt-10 text-indigo-400" text={`o`}/>
